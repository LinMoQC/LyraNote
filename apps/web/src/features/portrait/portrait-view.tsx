      ...
      <div className="sticky top-0 z-20 border-b border-foreground/[0.05] bg-background/80 px-8 py-5 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          <div className="flex items-center gap-3">
            <m.div
              className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-500/15 ring-1 ring-violet-500/20"
            ...
            <div>
              <h1 className="text-[17px] font-semibold text-foreground/90">{t("title")}</h1>
          ...
          <button
            ...
            disabled={triggering}
            className="flex items-center gap-1.5 rounded-lg border border-border/50 bg-muted/20 px-3.5 py-2 text-[12px] text-muted-foreground/70 transition-colors hover:border-violet-500/30 hover:bg-violet-500/8 hover:text-violet-300/80 disabled:opacity-40"
          >
          ...
          {!portrait ? (
            ...
            >
              ...
              <div className="grid grid-cols-5 gap-5">
                <div className="col-span-3"><KnowledgeMapCard portrait={portrait} /></div>
                <div className="col-span-2"><InteractionStyleCard portrait={portrait} /></div>
              </div>

              <div className="grid grid-cols-5 gap-5">
                <div className="col-span-3"><ThoughtStream portrait={portrait} /></div>
                <div className="col-span-2"><GrowthVelocityCard portrait={portrait} /></div>
              </div>
